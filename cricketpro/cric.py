...
with tab1:
    ...
    st.dataframe(
        data.sort_values('batting_elo', ascending=False)[
            ['batting_elo', 'total_runs', 'matches_played', 'bat_avg', 'strike_rate', 'milestone_1000_runs']
        ].head(50 if show_elite else 100),
...
with tab2:
    ...
    st.dataframe(
        data.sort_values('bowling_elo', ascending=False)[
            ['bowling_elo', 'total_wickets', 'matches_2plus_overs', 'bowling_avg', 'economy', 'wickets_per_match', 'milestone_100_wickets']
        ].head(50 if show_elite else 100),
        use_container_width=True
    )
...
with tab3:
    ...
    st.dataframe(
        data.sort_values('allrounder_elo', ascending=False)[
            ['allrounder_elo', 'batting_elo', 'bowling_elo', 'total_runs', 'total_wickets', 'matches_played', 'matches_2plus_overs']
        ].head(50 if show_elite else 100),
        use_container_width=True
    )
